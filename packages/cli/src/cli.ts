 ...
 */
import type { FileSystem } from 'effectscript-compiler/filesystem';
import { D } from 'effectscript-compiler/diagnostics/codes';
import { EFS_EXT } from 'effectscript-compiler/utils/constants';
...
async function handleInitCommand(args: ParsedArgs): Promise<number> {
  const { NodeFileSystem } = await import('effectscript-compiler/filesystem');
...
interface CompilerContext {
  readonly fs: import('effectscript-compiler/filesystem').FileSystem;
  readonly host: import('effectscript-compiler/host').CompilerHost;
  readonly files: string[];
  readonly formatDiagnostics: typeof import('effectscript-compiler/diagnostics/formatter').formatDiagnostics;
...
async function setupCompilerContext(args: ParsedArgs): Promise<CompilerContext | number> {
  const { NodeFileSystem } = await import('effectscript-compiler/filesystem');
  const { loadConfig, resolveConfig } = await import('effectscript-compiler/config');
  const { createCompilerHost } = await import('effectscript-compiler/host');
  const { formatDiagnostics } = await import('effectscript-compiler/diagnostics/formatter');
  ...
  const host = createCompilerHost(hostOpts as unknown as import('effectscript-compiler/host').CompilerHostOptions);
...
async function handleRunCommand(args: ParsedArgs): Promise<number> {
  ...
  const host = createCompilerHost(runHostOpts as unknown as import('effectscript-compiler/host').CompilerHostOptions);
...
function discoverFiles(
  ...
  config: import('effectscript-compiler/config').ProjectConfig,
