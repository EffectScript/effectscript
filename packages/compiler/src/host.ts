...
class CompilerHostImpl implements CompilerHost {
  ...
  async compile(
    ...
    if (merged.lazyResolutionBudget !== undefined) providerOpts['lazyResolutionBudget'] = merged.lazyResolutionBudget;
    const typeProvider = new TsCompilerApiProvider(providerOpts as unknown as import('./interop/provider.js').ProviderOptions);
