...
describe('suggested fixes', () => {
  it('renders fix description when present', () => {
    const d: Diagnostic = {
      ...
      fix: {
        description: "Declare 'x' as mutable with 'let mut'",
        edits: [],
      },
    };
    const result = formatDiagnostic(d, NO_COLOR);
    expect(result).toContain('fix:');
    expect(result).toContain("Declare 'x' as mutable with 'let mut'");
  });
  ...
  it('renders fix together with related spans', () => {
    const d: Diagnostic = {
      ...
      fix: {
        description: "Use 'let mut' for mutable binding",
        edits: [],
      },
    };
    const result = formatDiagnostic(d, NO_COLOR);
    ...
    expect(result).toContain('fix:');
    expect(result).toContain("Use 'let mut' for mutable binding");
